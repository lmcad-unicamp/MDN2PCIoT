...
int WriteInputFile(Graph Source_graph,
	...
	strcpy(filename, "ssd/AlexNet-");
	filename[12] = (char) (num_vertices / 10000) + '0';
	filename[13] = (char) (num_vertices % 10000 / 1000) + '0';
	filename[14] = (char) (num_vertices % 1000 / 100) + '0';
	filename[15] = (char) (num_vertices % 100 / 10) + '0';
	filename[16] = (char) (num_vertices % 10) + '0';
